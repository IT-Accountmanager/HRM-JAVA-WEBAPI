...
public class OnboardingEmployeeSummaryController {
	...
	public ResponseEntity<String> updateSummary(@RequestBody OnboardingEmployeeSummary summary,@PathVariable Integer id) {
		String result = this.onboardingEmployeeSummaryService.updateSummary(summary, id);
		return new ResponseEntity<>(result,HttpStatus.OK);
	}
	
	@DeleteMapping("/deleteSummary/{id}")
	public ResponseEntity<String> deleteSummary(@PathVariable Integer id) {
		String result = this.onboardingEmployeeSummaryService.deleteSummary(id);
		return new ResponseEntity<>(result, HttpStatus.OK);
	}
}
