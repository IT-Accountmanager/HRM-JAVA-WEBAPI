...
public class StructureController {
	...
	@GetMapping("/getEmployeeBySubDepartment/{subDepartment}")
	public ResponseEntity<List<String>> findEmployee(@PathVariable Sub_Department subDepartment) {
		List<String> employee = this.structureService.findEmployeesBySubDepartment(subDepartment);
		return new ResponseEntity<List<String>>(employee, HttpStatus.OK);
	}
	...
	public ResponseEntity<List<String>> findManager(@PathVariable Departments department,
		...
		List<String> result = this.structureService.findManagerByDepartment(department, subDepartment, manager);
		return new ResponseEntity<List<String>>(result, HttpStatus.OK);
	}

	@GetMapping("/getEmployeeByDepartment/{department}/{subDepartment}/{designation}")
	public ResponseEntity<List<String>> findEmployees(@PathVariable Departments department,
			@PathVariable Sub_Department subDepartment, @PathVariable String designation) {
		List<String> result = this.structureService.findEmployeesByDepartment(department, subDepartment, designation);
		return new ResponseEntity<List<String>>(result, HttpStatus.OK);
	}
