...
public class ColoredBorder {
	public static final String DEST = "C:\\Users\\Rameshrao.k\\Appointment Letter/colored_border.pdf";
	...
	protected void manipulatePdf(String dest) throws Exception {
		...
		Table table = new Table(com.itextpdf.layout.property.UnitValue.createPercentArray(2)).useAllAvailableWidth();
