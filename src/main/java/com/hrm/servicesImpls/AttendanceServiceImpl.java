...
public class AttendanceServiceImpl implements IAttendanceService {
	...
	public List<UserAttendanceDto> allAttendance(String employeeId) {
		try {
			...
			List<Attendance> allByEmployeeId = this.attendanceRepository.findAllByEmployeeId(employeeId);
			System.out.println(allByEmployeeId);
			 ...
			 * "Error retrieving attendance for employeeId: " + employeeId;
			 * logger.error(errorMessage, e);
			 * 
			 * System.out.println(errorMessage); e.printStackTrace(); // Print stack trace
			 * to console
			 * 
